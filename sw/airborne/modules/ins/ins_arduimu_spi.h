 ...
 *  \brief Interface for the ARDUIMU AHRS
 *  use the binary protocol on the SPI link
*/


#ifndef INS_ARDUIMU_H
#define INS_ARDUIMU_H
...
extern void ArduIMU_SPI_init( void );
extern void ArduIMU_SPI_periodic( void );
extern void ArduIMU_SPI_periodicGPS( void );
extern void ArduIMU_SPI_event( void );
extern void ArduIMU_SPI_report( void );
extern void ArduIMU_SPI_Parse( void );
...
#define ARDUIMU_MESSAGE_REQUEST 0x11
#define ARDUIMU_RESPONSE 0x12

#define ARDUIMU_GPS_SUPPLY 0x22
#define ARDUIMU_GPS_RESPONSE 0x23
